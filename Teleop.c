...
//
// In most cases, you may not have to add any code to this function and it will
// remain "empty".
//
/////////////////////////////////////////////////////////////////////////////////////////////////////
...
task main() {
  ...
  while (true) {
    ...
    } else if (Lim_top == CLOSED &&
               Lim_base == OPEN) // if top is pressed->CLOSED
    {
    ...
    } else if (Lim_top == OPEN &&
               Lim_base == CLOSED) // if bottom is pressed->CLOSED
    {
